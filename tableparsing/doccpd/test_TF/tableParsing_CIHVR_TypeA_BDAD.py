...
overlaydir              = filebasedir+'overlay/TypeA'
clouddir                = filebasedir+'cloud/TypeA'
...
overlay = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeA/SP2_00004.pdf.page-0_overlay.xml'   
...
for file,keypoints in tqdm.tqdm(data_full[:2]): #(5,6,10)      
    print(file)
    try:
