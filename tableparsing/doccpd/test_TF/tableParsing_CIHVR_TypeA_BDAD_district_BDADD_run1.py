...
from Filenames_TypeA import TypeA_filenames
...
crop_root               = filebasedirV+'minipics/TypeA_district'
overlaydir              = filebasedirV+'overlay/TypeA_top'
clouddir                = filebasedirV+'cloud/TypeA_top'
...
data_full = [x for x in data_full if x[0] in set(TypeA_filenames)]

template = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeA/SP2_00004.pdf.page-0_template.xml'
overlay = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeA/SP2_00004.pdf.page-0_overlay_district.xml'   
...
with open(tableparsingmetricsdir+f'tableParsing_CIHVR_TypeA_district_{str(begin)}-{str(end-1)}.pickle', 'wb') as handle:
