...
overlay = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_07119.pdf.page-0_overlay_bottom.xml'   
evaluation = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_07119.pdf.page-0_evaluation.xml'
...
with open(tableparsingmetricsdir+f'tableParsing_CIHVR_TypeB2_bottom_{str(begin)}-{str(end-1)}.pickle', 'wb') as handle:
