...
overlaydir              = filebasedir+'overlay/TypeA_top'
clouddir                = filebasedir+'cloud/TypeA_top'
...
with open(tableparsingmetricsdir+f'tableParsing_CIHVR_TypeA_top_{str(begin)}-{str(end-1)}.pickle', 'wb') as handle:
