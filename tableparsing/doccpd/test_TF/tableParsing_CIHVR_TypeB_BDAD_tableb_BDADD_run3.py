...
from Filenames_TypeB import typeB_filenames
...
overlaydir              = filebasedirV+'overlay/TypeB_bottom'
clouddir                = filebasedirV+'cloud/TypeB'
template_image_path     = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_24859.pdf.page-0.jpg'
...
data_full = [x for x in data_full if x[0] in set(typeB_filenames)]

template = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_24859.pdf.page-0_template.xml'
overlay = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_24859.pdf.page-0_overlay_bottom.xml'   
evaluation = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_24859.pdf.page-0_evaluation.xml'
...
with open(tableparsingmetricsdir+f'tableParsing_CIHVR_TypeB_bottom_{str(begin)}-{str(end-1)}.pickle', 'wb') as handle:
