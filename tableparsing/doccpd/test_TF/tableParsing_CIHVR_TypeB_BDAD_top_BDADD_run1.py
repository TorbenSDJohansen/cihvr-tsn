...
from Filenames_TypeB1_TypeB2 import TypeB_filenames
...
overlay = 'Y:/RegionH/Scripts/data/templates_and_overlays/TypeB/SP2_24859.pdf.page-0_overlay_top.xml'   
evaluation = template
...
with open(tableparsingmetricsdir+f'tableParsing_CIHVR_TypeB_top_{str(begin)}-{str(end-1)}.pickle', 'wb') as handle:
