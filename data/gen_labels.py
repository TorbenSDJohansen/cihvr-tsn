...
def init_verifiers() -> Dict[str, Callable]:
    ...
    lookup_verify = {
        ...
        **{f'tab-b-c7-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c8-{x}-mo': verifiers.verify_tab_b_123 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c9-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c10-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c11-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c12-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c13-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        **{f'tab-b-c14-{x}-mo': verifiers.verify_tab_b_012 for x in (1, 2, 3, 4, 6, 9, 12)},
        ...
        **{f'tab-b-c16-{x}-mo': verifiers.verify_tab_b_int for x in (1, 2, 3, 4, 6, 9, 12)},
        ...
        'preterm-birth': verifiers.verify_XXX, # FIXME/TODO construct new one??
