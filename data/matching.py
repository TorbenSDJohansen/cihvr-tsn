# -*- coding: utf-8 -*-
"""
Created on Tue May  4 13:31:12 2021
...
def main():
    ...
    ONLY support for 1:1 string matching as of yet. At some point, usefult to
    match e.g. a full name (first and last name) by working on each name
    individually.
